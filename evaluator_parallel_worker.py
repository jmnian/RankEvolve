"""
Worker entrypoint for ProcessPoolExecutor used by evaluator_parallel.py.

This module exists so that when OpenEvolve (or any loader) imports evaluator_parallel
under a different name (e.g. "evaluation_module"), spawned worker processes can still
unpickle the task: the task references evaluator_parallel_worker._worker_evaluate,
