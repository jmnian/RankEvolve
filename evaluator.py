...
DEFAULT_TOKENIZER = os.environ.get("EVAL_TOKENIZER", "lucene")  # Lucene to match BRIGHT/BEIR baselines
...
def evaluate_on_dataset(
    ...
    for qid, query_text in zip(query_ids, queries):
        ...
        relevant_indices = [
            id_to_idx[doc_id] for doc_id in relevant_doc_ids
...
""",
    ...
    if args.verbose:
        ...
        print(f"Datasets: {int(results['datasets_evaluated'])} evaluated, "
