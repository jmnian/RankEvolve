"""
BM25 reference implementation — single-file module used by the framework.

Provides a modular BM25 implementation with swappable IDF and TF strategies.
Self-contained in one file so seeds and the evaluator can import it without
pulling in additional package surface.
...
The `score_kernel` function and IDF/TF strategy classes are the primary
targets for the freeform evolution seed.
"""
