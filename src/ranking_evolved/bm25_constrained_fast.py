...
from ranking_evolved.bm25 import LUCENE_STOPWORDS
...
# =============================================================================
# LUCENE_STOPWORDS is imported from ranking_evolved.bm25
...
class Corpus:
    ...
    def idf_array(self) -> NDArray[np.float64]:
        ...
        return IDFFormula.compute(self._df, self.N)
...
class BM25:
    ...
    def __init__(
        ...
        self._idf_cache: dict[str, float] = {
            term: float(self.idf_array[term_id]) for term, term_id in corpus._vocab.items()
        }
